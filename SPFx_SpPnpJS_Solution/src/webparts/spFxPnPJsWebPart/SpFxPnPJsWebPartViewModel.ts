...
import styles from './SpFxPnPJsWebPart.module.scss';
import { ISpFxPnPJsWebPartWebPartProps } from './SpFxPnPJsWebPartWebPart';
import pnp, { List, ListEnsureResult, ItemAddResult, FieldAddResult } from "sp-pnp-js";

export interface ISpFxPnPJsWebPartBindingContext extends ISpFxPnPJsWebPartWebPartProps {
...
export default class SpFxPnPJsWebPartViewModel {
  ...
  public spFxPnPJsWebPartClass: string = styles.spFxPnPJsWebPart;
  ...
  constructor(bindings: ISpFxPnPJsWebPartBindingContext) {
